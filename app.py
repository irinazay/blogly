...
def posts_new(user_id):
    """Handle add form, add post, show message and redirect to the user detail page"""
...
def posts_update(post_id):
    """Handle form submission for updating an existing post, and show message."""
